...
class Ui_WndLogin(object):
    def setupUi(self, WndLogin):
        ...
        self.lbe_notice_text = QLabel(self.page_notice)
        self.lbe_notice_text.setObjectName(u"lbe_notice_text")
        self.lbe_notice_text.setMinimumSize(QSize(300, 0))
        self.lbe_notice_text.setFrameShape(QFrame.Box)
        self.lbe_notice_text.setFrameShadow(QFrame.Raised)
        self.lbe_notice_text.setMidLineWidth(0)
        self.lbe_notice_text.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        self.lbe_notice_text.setWordWrap(True)

        self.gridLayout_9.addWidget(self.lbe_notice_text, 1, 1, 1, 1)
        ...
        QWidget.setTabOrder(self.btn_exit, self.edt_login_account)
        ...
        QWidget.setTabOrder(self.chk_login_remember, self.edt_reg_account)
        QWidget.setTabOrder(self.edt_reg_account, self.edt_reg_qq)
        QWidget.setTabOrder(self.edt_reg_qq, self.edt_reg_pwd)
        QWidget.setTabOrder(self.edt_reg_pwd, self.btn_reg)
...
#if QT_CONFIG(tooltip)
        self.edt_pay_account.setToolTip(QCoreApplication.translate("WndLogin", u"\u5b57\u6bcd\u6570\u5b57\u7ec4\u5408, 6-12\u4f4d", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.edt_modify_account.setToolTip(QCoreApplication.translate("WndLogin", u"\u5b57\u6bcd\u6570\u5b57\u7ec4\u5408, 6-12\u4f4d", None))
#endif // QT_CONFIG(tooltip)
        self.label_12.setText(QCoreApplication.translate("WndLogin", u"QQ:", None))
#if QT_CONFIG(tooltip)
        self.edt_modify_qq.setToolTip(QCoreApplication.translate("WndLogin", u"\u8bf7\u8f93\u5165\u6ce8\u518c\u8d26\u53f7\u65f6\u9884\u7559\u7684QQ\u53f7", None))
#endif // QT_CONFIG(tooltip)
